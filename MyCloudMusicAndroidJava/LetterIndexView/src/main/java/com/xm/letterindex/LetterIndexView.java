...
public class LetterIndexView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            fontSize = (int) array.getDimension(R.styleable.LetterIndex_letter_text_size, 0);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (heightMode == MeasureSpec.EXACTLY) { // 固定高度
            ...
            itemHeight = (int) paint.measureText(getFirstLetter()) + itemPadding * 2;
            height = itemHeight * letterList.size();
        }
        height += getPaddingTop() + getPaddingBottom();
        int width = (int) (paint.measureText(getFirstLetter()) + getPaddingLeft() + getPaddingRight());
